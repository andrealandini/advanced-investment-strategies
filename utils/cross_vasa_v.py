...
metrics_df.to_csv('../data/vasa_cross_metrics_v.csv', index=False)
print("✅ Saved ../data/vasa_cross_metrics_v.csv")

r2_df = pd.DataFrame({'Train_R2': [np.nan], 'Test_R2': [metrics['R2']]}, index=['VASA_Cross'])
r2_df.to_csv('../data/vasa_cross_r2_v.csv')
print("✅ Saved ../data/vasa_cross_r2_v.csv")
