...
r2_df.to_csv('../data/entropy-output/vasa_r2_e.csv')
print("✅ Saved ../data/entropy-output/vasa_r2_e.csv")

metrics_df = pd.DataFrame([metrics_train, metrics_test], index=['Train', 'Test'])
metrics_df.to_csv('../data/entropy-output/vasa_metrics_e.csv')
print("✅ Saved ../data/entropy-output/vasa_metrics_e.csv")
